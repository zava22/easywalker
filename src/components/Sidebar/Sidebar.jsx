        ...
        <>
            ...
            <div className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
                ...
                <div className="sidebar-bottom">
                    <div className="bottom-item" onClick={() => window.dispatchEvent(new CustomEvent('openSettings'))}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <div className="bottom-item" onClick={() => window.dispatchEvent(new CustomEvent('openShortcuts'))}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
