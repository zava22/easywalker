            ...
            {chats.length === 0 ? (
              <div className="first-visit-welcome">
                ...
                <p className="first-visit-subtitle">
                  Создайте новый чат и начинайте общаться с искусственным интеллектом. 
                  Задавайте вопросы, получайте помощь в программировании, творчестве и многом другом.
                </p>
              ...
              <div className="empty-chat-welcome">
                ...
                <p className="welcome-subtitle">
                  Я ваш AI-помощник. Чем могу помочь сегодня?
                </p>
